...
<head>
    ...
    <title>Admin Panel - {{ config('app.name', 'NeighborMart') }}</title>
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <aside class="w-72 glass-sidebar flex flex-col fixed inset-y-0 left-0 z-50 transition-transform duration-300 transform md:relative md:translate-x-0 group">
            ...
            <div class="h-20 flex items-center px-8 border-b border-white/5">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 group-hover:scale-105 transition-transform duration-300">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-400 font-medium tracking-wide">ADMIN PANEL</p>
                    </div>
                </a>
            </div>
            ...
            <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-8">
                ...
                <div>
                    ...
                    <ul class="space-y-1">
                        <li>
                            <a href="{{ route('admin.dashboard') }}" class="nav-link flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 transition-all duration-300 {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
                ...
                <div>
                    ...
                    <ul class="space-y-1">
                        <li>
                            <a href="{{ route('admin.categories.index') }}" class="nav-link flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 transition-all duration-300 {{ request()->routeIs('admin.categories.*') ? 'active' : '' }}">
                                <i class="fas fa-layer-group w-5 text-center"></i>
                                <span class="font-medium text-sm">Categories</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.sellers.index') }}" class="nav-link flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 transition-all duration-300 {{ request()->routeIs('admin.sellers.*') ? 'active' : '' }}">
                                <i class="fas fa-store w-5 text-center"></i>
                                <span class="font-medium text-sm">Sellers</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.products.index') }}" class="nav-link flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 transition-all duration-300 {{ request()->routeIs('admin.products.*') ? 'active' : '' }}">
                                <i class="fas fa-box w-5 text-center"></i>
                                <span class="font-medium text-sm">Products</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.users.index') }}" class="nav-link flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 transition-all duration-300 {{ request()->routeIs('admin.users.*') ? 'active' : '' }}">
                                <i class="fas fa-users w-5 text-center"></i>
                                <span class="font-medium text-sm">Customers</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('admin.orders.index') }}" class="nav-link flex items-center gap-3 px-4 py-3 rounded-xl text-gray-400 transition-all duration-300 {{ request()->routeIs('admin.orders.*') ? 'active' : '' }}">
        ...
        <div class="flex-1 flex flex-col h-screen overflow-hidden bg-[#f6f8f8] relative">
            ...
            <header class="h-20 glass-header flex items-center justify-between px-8 z-40">
                ...
                <div class="flex items-center gap-6">
                    <!-- Notifications -->
                    <a href="{{ route('admin.notifications.index') }}" class="relative text-gray-400 hover:text-primary-cyan transition-colors">
