...
<div class="min-h-screen flex items-center justify-center bg-[#f6f8f8] py-12 px-4 sm:px-6 lg:px-8 animate-fade-in">
    <div class="max-w-md w-full space-y-8 glass-card p-10 rounded-3xl shadow-2xl border border-white/20 backdrop-blur-md animate-scale-in hover:shadow-3xl transition-shadow duration-500">
        ...
        <div class="text-center">
            ...
            <h2 class="mt-6 text-3xl font-extrabold text-[#2E282A]">Forgot Password</h2>
        ...
        <!-- Status Message -->
        @if (session('status'))
            <div class="bg-[#13ecc8]/20 border border-[#13c8ec] text-[#13c8ec] px-4 py-3 rounded-md text-center font-medium animate-pulse">
                {{ session('status') }}
            </div>
        @endif
